...
class Paths:
    WORK_PATH = "/content/Talhas-Mirror-1/BOT_WORK"
    THMB_PATH = "/content/Talhas-Mirror-1/Thumbnail.jpg"
    VIDEO_FRAME = f"{WORK_PATH}/video_frame.jpg"
    HERO_IMAGE = f"{WORK_PATH}/Hero.jpg"
    DEFAULT_HERO =  "/content/Talhas-Mirror-1/custom_thmb.jpg"
    ...
    access_token = "/content/Talhas-Mirror-1/token.pickle"
